 ...
 */
final class Version20230108143811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mentorship ADD project_id INT NOT NULL');
        $this->addSql('ALTER TABLE mentorship ADD CONSTRAINT FK_ADE55FF4166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
        $this->addSql('CREATE INDEX IDX_ADE55FF4166D1F9C ON mentorship (project_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_ADE55FF4166D1F9C ON mentorship');
        $this->addSql('ALTER TABLE mentorship DROP project_id');
    }
}
